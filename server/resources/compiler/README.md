...
The compiler remains a subprocess. `-s` prevents writing build artifacts and `--no-require-entry-point` enables syntax and semantic validation of standalone includes. No WASM or AST migration is included.
